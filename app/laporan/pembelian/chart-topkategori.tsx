...
export default function ChartTopKategori({ laporan }: { laporan: LaporanSummary }) {
  ...
  if (chartData.length === 0) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Top 5 Kategori Pembelian (Rp)</CardTitle>
        </CardHeader>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="warp-break-words text-center text-xl font-bold">Top 5 Kategori Pembelian (Rp)</CardTitle>
      </CardHeader>
