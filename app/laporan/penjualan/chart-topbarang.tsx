...
export default function ChartTopBarang({ laporan }: { laporan: LaporanSummary }) {
  ...
  if (chartData.length === 0) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Top 5 Jumlah Barang Terjual</CardTitle>
        </CardHeader>
  ...
  return (
    <Card className="border-3">
      <CardHeader>
        <CardTitle className="warp-break-words text-center text-xl font-bold">Top 5 Jumlah Barang Terjual</CardTitle>
      </CardHeader>
